...
public:
    ...
    void solution(int n){
        ...
        for(int i=0;i<n;i++){
            cin>>vertex;
            if(initColor[strToInt[vertex]]==sol[strToInt[vertex]]){
                cout<<"TRUE\n";
            }
            else{
                if(initColor[strToInt[vertex]]==-1){
                    cout<<sol[strToInt[vertex]]<<"\n";
                }
                else{
                    cout<<"FALSE\n";
                }
